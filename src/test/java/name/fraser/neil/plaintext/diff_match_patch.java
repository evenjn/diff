...
import org.github.evenjn.diff.diff_adapter;
...
public class diff_match_patch {
	...
	public boolean use_diff_adapter = true;
  ...
  public LinkedList<Diff> diff_main(String text1, String text2,
    ...
    if (use_diff_adapter && !checklines) {
    	return diff_adapter.diff_main_nc(text1, text2, deadline);
    }
  ...
  protected LinkedList<Diff> diff_bisect(String text1, String text2,
      long deadline) {
  	if (use_diff_adapter) {
  		return diff_adapter.diff_bisect(text1, text2, deadline);
  	}
  ...
  public void diff_cleanupMerge(LinkedList<Diff> diffs) {
  	if (use_diff_adapter) {
  		diff_adapter.diff_cleanupMerge(diffs);
  		return;
  	}
